        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    City = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FullMatchPrice = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubSchedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClubSchedules_Clubs_ClubId",
                        column: x => x.ClubId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourtId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CourtBookingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StartsAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndsAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RequiredCategory = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Matches_CourtBookings_CourtBookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClubSchedules_ClubId_DayOfWeek_OpensAt_ClosesAt",
                table: "ClubSchedules",
                columns: new[] { "ClubId", "DayOfWeek", "OpensAt", "ClosesAt" });

            migrationBuilder.CreateIndex(
                name: "IX_CourtBookings_CourtId_StartsAtUtc_EndsAtUtc",
                table: "CourtBookings",
                columns: new[] { "CourtId", "StartsAtUtc", "EndsAtUtc" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JoinRequests_MatchId_UserId",
                table: "JoinRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_CourtBookingId",
                table: "Matches",
